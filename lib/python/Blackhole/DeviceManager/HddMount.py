...
from Tools.Directories import fileExists, crawlDirectory, SCOPE_CURRENT_PLUGIN
...
def MountEntry(description, details):
	picture = LoadPixmap(cached = True, path = ("/usr/lib/enigma2/python/Blackhole/DeviceManager/icons/diskusb.png"));
