...
if width == 1280:
         OscamInfoMenu_SKIN = """
        <screen position="center,center" size="500,250" title="Ncam Info" >
                <widget name="mainmenu" position="0,0" size="500,250" scrollbarMode="showOnDemand" />
        </screen>"""
elif width == 1920:
        OscamInfoMenu_SKIN = """
        <screen position="center,center" size="800,350" title="Ncam Info">
                <widget name="mainmenu" position="0,0" size="800,350" scrollbarMode="showOnDemand" />
        </screen>"""
else:
        OscamInfoMenu_SKIN = """
        <screen position="center,center" size="500,250" title="Ncam Info" >
...
class oscECMInfo(Screen, OscamInfo):
    sizeLH = sizeH - 20
    skin = '<screen position="center,center" size="%s, 350" title="ECM Info" >\n\t\t\t<widget name="output" position="10,10" size="%s, 350" scrollbarMode="showOnDemand" />\n\t\t</screen>' % (sizeH, sizeLH)
